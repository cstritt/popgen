...
# vcf = '/home/cristobal/data/bdis/variants/bdis198.SNPs.HF.het_included.vcf.gz'
# vcf = '/home/cristobal/data/bdis/variants/bdis198.out_Cef2.SNPs.highC_regions.HF.vcf.gz'



# chromosomes = ['Bd1', 'Bd2', 'Bd3', 'Bd4', 'Bd5']

# het_d, contigs = create_het_dict(vcf, chromosomes)

# accessions = list(het_d.keys())

# summary = [['acc', 'chr', 'nr_ifh', 'nr_het_snps', 
#            'ifh_min_len', 'ifh_max_len', 'ifh_mean_len', 
#            'nr_snps_min', 'n_snps_max', 'n_snps_mean']]
